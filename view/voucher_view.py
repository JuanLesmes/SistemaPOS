...
class VoucherView(ctk.CTkToplevel):
    ...
    def _create_widgets(self):
        ...
        franja_decorativa = ctk.CTkFrame(self, height=4, fg_color=self.franja_color, corner_radius=0)
        ...
        self.tree = ttk.Treeview(table_frame, columns=columns, show="headings", style="Voucher.Treeview")
        for col, heading, width, anchor in [
            ("cantidad", "CANTIDAD", 80, "center"),
            ("nombre", "PRODUCTO", 250, "w"),
            ("precio_unitario", "PRECIO UNITARIO", 150, "e"),
            ("total_parcial", "TOTAL PARCIAL", 150, "e")
        ]:
        ...
        # Totales y botón en misma línea
        ...
        # Botón Volver a Ventas a la izquierda
        ...
        # Container para labels de totales a la derecha
        labels_container = ctk.CTkFrame(totales_frame, fg_color=fondo)
        labels_container.grid(row=0, column=1, sticky="e")
        ...
        for lbl in (self.lbl_total, self.lbl_recibido, self.lbl_vueltas):
            lbl.pack(anchor="e")
    ...
    def load_receipt_data_from_objects(self):
        ...
        self._pending_after_ids.append(self.after(100, self.lift))
